...
const debug = _debug('wux-command:helper')
 ...
 * @return {Promise} err or undefined
 */
export const npmInstall = (npmCli, name, cwd) => {
  const options = {
    stdio: 'inherit',
    env: process.env,
    cwd
 ...
 */
export const callFn = function*(fn, args = [], thisArg) {
 ...
 */
export const unparseArgv = (argv, options = {}) => {
 ...
 */
export const extractExecArgv = argv => {
  const debugOptions = {}
  const execArgvObj = {}
  let debugPort
