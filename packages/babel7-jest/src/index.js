...
import {transformSync as babelTransformSync, util as babelUtil} from '@babel/core'
...
const createTransformer = options => {
  ...
  return {
    ...
    process(
      ...
      const babelConfig = config.globals && config.globals['babel7-jest'] || {}
      const theseOptions = Object.assign({filename}, options, babelConfig)
      ...
      const transformResult = babelTransformSync(src, theseOptions)
