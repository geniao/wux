...
function (_Command) {
  ...
  function DevCommand(rawArgv) {
    ...
    _this.hooks.init.tap('DevCommand', function () {
      var Te = _this.getTechnicalEcology();

      new Te().apply(_assertThisInitialized(_assertThisInitialized(_this)));
    });
  ...
  function () {
    ...
    _regenerator.default.mark(function _callee() {
      var _this$hooks$config$ca, webpackConfig, serverConfig, browserConfig, compiler, result;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _this$hooks$config$ca = this.hooks.config.call({}), webpackConfig = _this$hooks$config$ca.webpackConfig, serverConfig = _this$hooks$config$ca.serverConfig, browserConfig = _this$hooks$config$ca.browserConfig;
