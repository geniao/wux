...
function (_WuxCommand) {
  ...
  function Command(rawArgv) {
    ...
    _this.yargs.epilogue('版权所有 ©2018 UX');
  ...
  _proto.getTechnicalEcology = function getTechnicalEcology() {
    ...
    try {
      abc = yaml.safeLoad(_fs.default.readFileSync(_path.default.resolve('abc.yml'), 'utf8'));
    } catch (e) {
      console.log(e);
    }
  ...
  _proto.installSuite = function installSuite() {};
