...
var dist = _path.default.resolve('dist/umd');
...
var webpackConfig = {
  ...
  mode: 'development',
  entry: [_path.default.resolve('src/index')],
  output: {
    filename: '[name].js',
    path: dist,
    publicPath: '/'
  ...
  module: {
    rules: [{
      ...
      use: ['style-loader', 'css-loader', {
        ...
        options: {
          config: {
            path: _path.default.resolve(_path.default.join(__dirname, '..', 'postcss', 'postcss.config.js'))
          }
        }
      }]
    }, {
